...
public class EventTest {
    ...
    void setUp() {
        ...
        event = new Event(discounts, gifts);
    }
    ...
    @ParameterizedTest
    @CsvSource(value = {"티본스테이크-2,레드와인-1:9:164154", "바비큐립-1,시저샐러드-1,아이스크림-2:25:63554"}, delimiter = ':')
    void 할인_후_예상_결제금액을_계산한다(String 주문, int 방문_날짜, int 에상_결제금액) {
        VisitDate visitDate = new VisitDate(방문_날짜);
        Orders orders = new Orders(주문);
